...
<section><br>
<div class="srch">
		<form class="navbar-form" method="post" name="form1" action="adminModifyBookRecord.php">
					...
					while($row = mysqli_fetch_array($result)) 
										{
											...
											echo"<td align = 'center'>".$row["COPIES"];"</td><br>";
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo '<a style="padding-left:15px; font-size: 30px; color: white;" href="adminModifyBookRecord.php?page=' . $page . '">' . $page . '</a> ';
