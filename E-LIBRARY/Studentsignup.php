...
<body>
	...
	<section>
		...
		<div class="box1">
		<div class="sfrm">
			<h1 style="text-align: center; font-size: 45px;color: orangered">STUDENT SIGNUP FORM</h1>
 <form action="Studentdata.php" method="post" onsubmit="return valid();">
  <table>
   	 <tr>
    <td>User ID :</td>
    ...
    <td>Course :</td>
    <td><input style="font-size:18pt;height:30px;width:200px;"  type="text" name="course" required></td>
   </tr>
	 <tr>
    <td>Batch :</td>
    <td><input style="font-size:18pt;height:30px;width:200px;"  type="text" name="joinYear" required> to <input style="font-size:18pt;height:30px;width:200px;"  type="text" name="endYear" required></td>
    </tr>
          <tr>
    <td>Password :</td>
