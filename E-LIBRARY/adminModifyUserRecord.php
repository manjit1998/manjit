...
<section><br>
<div class="srch">
		<form class="navbar-form" method="post" name="form1" action="adminModifyUserRecord.php">
...
<?php
        ...
        //Table header
					...
					while($row = mysqli_fetch_array($result)) 
										{
											echo "<form action='updateRecordForm.php' method='post'>";
...
for ($page=1;$page<=$number_of_pages;$page++) {
  echo '<a style="padding-left:15px; font-size: 30px; color: white;" href="adminModifyUserRecord.php?page=' . $page . '">' . $page . '</a> ';
